#![allow(warnings)]
use crate::{board::{Board, print_bitboard}, defs::{Castling, Color, FILES_BOARD, Piece, PieceType, RANKS_BOARD, Ranks}, fens::{FEN_1, FEN_ENPASSANT, FEN_PROMOTION_BLACK, FEN_PROMOTION_WHITE, FEN_SQUARE_ATTACKED, FEN_START, KIWIPETE}, movegen::{MoveFlag, MoveList, bitboards::RANK_BB_MASK}, perft::{perft, perft_divide}};
