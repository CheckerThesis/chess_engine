...
use crate::{board::check_board, data::{PIECE_CHAR, PIECE_COLOR}, defs::{Board, MoveList, Pieces::{self, *}, Ranks::*, Squares::{NoSq, OffBoard}, FILES_BOARD, MOVE_FLAG_EN_PASSENT, MOVE_FLAG_PAWN_START, RANKS_BOARD}, io::print_square, validate::{piece_valid, piece_valid_empty, square_on_board}, BLACK, WHITE};
...
pub fn generate_all_moves(position: &mut Board, move_list: &mut MoveList) {
    ...
    let mut piece_index = loop_slide_index[side as usize];
